    ...
    <div ref={containerRef} className="relative">
      ...
      {usesCustomVerticalScrollbar && hasCustomVerticalOverflow && (
        <div
          ref={setOverlayRef}
          aria-hidden="true"
          className="pointer-events-none absolute inset-e-0 top-[var(--data-grid-scrollbar-header-height)] z-20 h-[var(--data-grid-scrollbar-track-height)]"
        >
          <div
          ...
          >
            <div
              className={cn(
                ...
                "top-[var(--data-grid-scrollbar-thumb-top)] h-[var(--data-grid-scrollbar-thumb-height)]",
                "rounded-full"
              )}

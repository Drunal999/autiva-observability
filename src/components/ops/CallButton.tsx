      ...
      {call && (
        ...
        >
          <div className="flex items-center gap-3 border-b border-white/8 px-4 py-2.5">
            <span className="font-mono text-[13px] font-bold uppercase tracking-[0.14em] text-white/55">
              Call
            </span>
            ...
            <span className="hidden font-mono text-[11.5px] text-white/25 sm:inline">
              Esc to leave
            </span>
            <button
              type="button"
              onClick={() => setCall(null)}
              className="h-7 rounded-[8px] border border-white/12 px-2.5 font-mono text-[12px] text-white/60 transition hover:text-white focus:outline-none focus-visible:ring-2 focus-visible:ring-white/30"
            >
              Leave
            </button>
          </div>
